...
const CallToAction = () => {
    ...
    return (
        <>
            ...
            <section className="py-12 bg-indigo-600 dark:bg-indigo-900 text-white relative transition-colors duration-500">
                <div className="container mx-auto px-4 text-center">
                    ...
                    <div className="flex flex-col sm:flex-row justify-center gap-4">
                        <Button
                            ...
                            size="lg"
                            variant="secondary"
                            className="font-bold text-indigo-700 dark:text-indigo-900 hover:text-indigo-800 dark:hover:text-indigo-950"
                        >
                        ...
                        <Button
                            ...
                            size="lg"
                            className="bg-green-500 hover:bg-green-600 text-white font-bold shadow-lg shadow-green-500/20"
                        >
