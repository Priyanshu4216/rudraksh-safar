    ...
    >
      ...
      <div className="absolute inset-0 p-6 flex flex-col justify-end">
        <div className="transform translate-y-4 group-hover:translate-y-0 transition-transform duration-300">
          ...
          <p className="text-primary-foreground/80 text-xs md:text-sm opacity-0 group-hover:opacity-100 transition-opacity duration-300">
            Best time: {getBestTimeToVisit({ location: destination.name })}
          </p>
        </div>
