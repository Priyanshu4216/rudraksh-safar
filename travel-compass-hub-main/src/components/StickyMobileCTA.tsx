    ...
    return (
        <div className="fixed bottom-0 left-0 right-0 p-4 transition-transform z-50 md:hidden animate-in slide-in-from-bottom border-t shadow-[0_-4px_20px_-5px_rgba(0,0,0,0.1)] bg-background/80 backdrop-blur-lg">
            <div className="flex items-center gap-3 w-full max-w-md mx-auto">
                ...
                <div className={`flex gap-2 ${!price ? 'w-full justify-between' : ''}`}>
                    <Button
                        size="icon"
                        variant="outline"
                        ...
                        onClick={() => {
                            ...
                            window.open('tel:+919203650311', '_self');
                        }}
                    >
                    ...
                    <Button
                        ...
                        onClick={() => {
                            ...
                            window.open('https://wa.me/919203650311?text=Hi, I am interested in this package', '_blank');
                        }}
                    >
