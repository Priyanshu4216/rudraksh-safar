        ...
        <div className="sib-form" style={{ textAlign: 'center', backgroundColor: '#EFF2F7' }}>
            <div id="sib-form-container" className="sib-form-container">
                ...
                <div id="sib-container" className="sib-container--large sib-container--vertical" style={{ textAlign: 'center', backgroundColor: 'rgba(255,255,255,1)', maxWidth: '540px', borderRadius: '3px', borderWidth: '1px', borderColor: '#C0CCD9', borderStyle: 'solid', direction: 'ltr' }}>
                    <form id="sib-form" method="POST" action="https://e4dcc250.sibforms.com/serve/MUIFAIjKsd963n3akdpffuku6XpgoYowvL-H4QFRHKto_s7aSJG1I5E6bzHkfqQzcRPvUUZe5Td-oEoHssEr2Pa1OXspOuOrptIQps0wbjs52Ehdza6zRXKKH-bi38fRqy-3wtAy-PAG5eNsn0tRjCvJ2-TOxK8r4XuaqzRm7AV37i7uEYIbiMfLD54J4bAACYzUV98OQXRENuzivw==" data-type="subscription">
