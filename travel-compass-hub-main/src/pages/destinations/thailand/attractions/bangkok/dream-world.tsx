                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
                    ...
                    <div className="lg:col-span-8 space-y-16">
                        ...
                        <section className="prose prose-lg dark:prose-invert max-w-none">
                            <h2 className="text-3xl font-serif font-bold text-foreground">Discover Dream World</h2>
                            <p className="text-muted-foreground leading-relaxed text-lg">
                                Nestled in the heart of Bangkok, Dream World stands as an emblem of the city's vibrant tourist scene. 
                        ...
                        <section>
                            ...
                            <div className="p-6 bg-muted/20 border rounded-xl flex items-start gap-4">
                                ...
                                <div>
                                    <p className="font-bold text-lg mb-1">Dream World, Bangkok</p>
                        ...
                        <div className="sticky top-24 space-y-8">
                            ...
                            <div className="bg-card rounded-2xl border shadow-xl overflow-hidden">
                                ...
                                <div className="p-8">
                                    ...
                                    <p className="text-muted-foreground mb-6">Add Dream World to your custom Bangkok itinerary. Let our experts handle the tickets and transfers.</p>
