...
const ElephantTrekking = () => {
    useEffect(() => { window.scrollTo(0, 0); }, []);

    return (
        <div className="min-h-screen bg-background font-sans">
            <Helmet>
                <title>Elephant Trekking Tour | Krabi Travel Guide for Indians</title>
                <meta name="description" content="Complete guide to Elephant Trekking in Krabi. Facts, timings, tickets, and travel tips for tourists." />
            </Helmet>
            ...
            <div className="relative h-[60vh] md:h-[80vh] min-h-[500px]">
                <img
                    src="https://upload.wikimedia.org/wikipedia/commons/thumb/3/3e/Navann_was_born_at_the_park_Oct_2012.jpg/960px-Navann_was_born_at_the_park_Oct_2012.jpg"
                    alt="Elephant Trekking"
                ...
                <div className="absolute bottom-0 left-0 right-0 p-6 md:p-16 container mx-auto text-foreground">
                    ...
                    <h1 className="text-4xl md:text-6xl lg:text-7xl font-serif font-bold mb-4 text-white drop-shadow-lg">Elephant Trekking</h1>
                    <p className="text-lg md:text-2xl max-w-2xl text-gray-200 mb-6 font-medium drop-shadow-md">An iconic experience in Krabi offering unforgettable memories and stunning sights.</p>
                </div>
            </div>
                    ...
                    <div className="lg:col-span-8 space-y-16">
                        ...
                        <div className="flex flex-wrap gap-6 p-6 rounded-2xl border border-border bg-card shadow-sm">
                            ...
                            <div className="flex items-center gap-3 pr-6 border-r border-border/50">
                                ...
                                <div><span className="block text-xs uppercase tracking-wider text-muted-foreground font-semibold">Location</span><span className="font-bold text-sm">Central Krabi</span></div>
                            </div>
                        ...
                        <section className="prose prose-lg dark:prose-invert max-w-none">
                            <h2 className="text-3xl font-serif font-bold text-foreground">Discover Elephant Trekking</h2>
                            <p className="text-muted-foreground leading-relaxed text-lg">
                                Nestled in the heart of Krabi, Elephant Trekking stands as an emblem of the city's vibrant tourist scene. 
                        ...
                        <section>
                            ...
                            <div className="p-6 bg-muted/20 border rounded-xl flex items-start gap-4">
                                ...
                                <div>
                                    <p className="font-bold text-lg mb-1">Elephant Trekking, Krabi</p>
                        ...
                        <div className="sticky top-24 space-y-8">
                            ...
                            <div className="bg-card rounded-2xl border shadow-xl overflow-hidden">
                                ...
                                <div className="p-8">
                                    ...
                                    <p className="text-muted-foreground mb-6">Add Elephant Trekking to your custom Krabi itinerary. Let our experts handle the tickets and transfers.</p>
                            ...
                            <div className="p-6 border rounded-2xl bg-card shadow-sm">
                                <h4 className="font-serif font-bold text-xl mb-4">More in Krabi</h4>
                                <ul className="space-y-4">
                                    <li>
                                        <Link to="/destinations/thailand/krabi" className="group flex items-center justify-between text-muted-foreground hover:text-primary transition-colors">
                                            <span className="font-semibold">Explore Krabi Guide</span>
...
export default ElephantTrekking;
