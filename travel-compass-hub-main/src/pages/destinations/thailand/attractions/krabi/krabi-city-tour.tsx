...
const KrabiCityTour = () => {
    ...
    return (
        <div className="min-h-screen bg-background font-sans">
            <Helmet>
                <title>Krabi City Tour Tour | Krabi Travel Guide for Indians</title>
                <meta name="description" content="Complete guide to Krabi City Tour in Krabi. Facts, timings, tickets, and travel tips for tourists." />
            </Helmet>
            ...
            <div className="relative h-[60vh] md:h-[80vh] min-h-[500px]">
                <img
                    src="https://upload.wikimedia.org/wikipedia/commons/thumb/4/44/Wat_Tham_Sua_18.jpg/960px-Wat_Tham_Sua_18.jpg"
                    alt="Krabi City Tour"
                ...
                <div className="absolute bottom-0 left-0 right-0 p-6 md:p-16 container mx-auto text-foreground">
                    ...
                    <h1 className="text-4xl md:text-6xl lg:text-7xl font-serif font-bold mb-4 text-white drop-shadow-lg">Krabi City Tour</h1>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
                    ...
                    <div className="lg:col-span-8 space-y-16">
                        ...
                        <section className="prose prose-lg dark:prose-invert max-w-none">
                            <h2 className="text-3xl font-serif font-bold text-foreground">Discover Krabi City Tour</h2>
                            <p className="text-muted-foreground leading-relaxed text-lg">
                                Nestled in the heart of Krabi, Krabi City Tour stands as an emblem of the city's vibrant tourist scene. 
                        ...
                        <section>
                            ...
                            <div className="p-6 bg-muted/20 border rounded-xl flex items-start gap-4">
                                ...
                                <div>
                                    <p className="font-bold text-lg mb-1">Krabi City Tour, Krabi</p>
                        ...
                        <div className="sticky top-24 space-y-8">
                            ...
                            <div className="bg-card rounded-2xl border shadow-xl overflow-hidden">
                                ...
                                <div className="p-8">
                                    ...
                                    <p className="text-muted-foreground mb-6">Add Krabi City Tour to your custom Krabi itinerary. Let our experts handle the tickets and transfers.</p>
