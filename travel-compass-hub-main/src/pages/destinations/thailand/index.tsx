...
const ThailandHub = () => {
    ...
    const cityAttractions: Record<string, { name: string; image: string; link: string; category: string; quickInfo: string[]; microDesc: string }[]> = {
        pattaya: [
            ...
            { name: "Coral Island", image: "/images/Discover/Thailand/Pattaya/coral island.webp", link: "/destinations/thailand/attractions/pattaya/coral-island", category: "Adventure • Nature", quickInfo: ["Full Day", "Popular"], microDesc: "Crystal clear waters perfect for snorkeling and water sports." },
            { name: "Tiger Park", image: "/images/Discover/Thailand/Pattaya/tiger parl.webp", link: "/destinations/thailand/attractions/pattaya/tiger-park", category: "Wildlife • Family", quickInfo: ["2-3 Hours", "Unique"], microDesc: "Get up close and personal with majestic tigers in a safe environment." },
            { name: "Alcazar Show", image: "/images/Discover/Thailand/Pattaya/alcazar-cabaret-show.webp", link: "/destinations/thailand/attractions/pattaya/alcazar-show", category: "Nightlife • Cultural", quickInfo: ["Evening", "Unmissable"], microDesc: "A dazzling, world-famous cabaret performance full of color and music." },
            ...
            { name: "Tiffany Show", image: "/images/Discover/Thailand/Pattaya/tiffany-s-show-pattaya.webp", link: "/destinations/thailand/attractions/pattaya/tiffany-show", category: "Nightlife • Entertainment", quickInfo: ["Evening", "Premium"], microDesc: "The original transvestite cabaret show offering spectacular theatricals." },
                ...
                <div className="bg-card shadow-xl rounded-3xl p-8 md:p-12 border border-border text-center max-w-4xl mx-auto mb-20 relative overflow-hidden">
                    ...
                    <div className="relative z-10">
                        ...
                        <p className="text-muted-foreground mb-8 text-lg max-w-2xl mx-auto">
                            Explore our Thailand tour packages for a hassle-free trip. We offer special packages configured with the best Indian food arrangements and premium stays. Connect with our local travel agents in <Link to="/travel-agent-bhilai" className="text-primary hover:underline">Bhilai</Link>, <Link to="/travel-agent-raipur" className="text-primary hover:underline">Raipur</Link>, and <Link to="/travel-agent-durg" className="text-primary hover:underline">Durg</Link> to customize your perfect Thai getaway.
                        </p>
