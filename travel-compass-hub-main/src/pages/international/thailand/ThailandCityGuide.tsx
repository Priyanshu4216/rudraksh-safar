    ...
    return (
        <>
            <Helmet>
                ...
                <link rel="canonical" href={`https://rudrakshsafar.com/international-tours/thailand/${city.id}`} />
            </Helmet>
            ...
            <main className="min-h-screen bg-slate-50 dark:bg-slate-950 text-foreground">
                ...
                <div className="relative h-[60vh] flex items-center justify-center overflow-hidden">
                    ...
                    <div className="relative z-10 container text-center text-white">
                        <Link to="/international-tours/thailand" className="inline-flex items-center text-slate-300 hover:text-white mb-6 uppercase tracking-widest text-xs font-bold transition-colors">
