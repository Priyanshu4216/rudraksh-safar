...
import { Train, Plane, Wallet, AlertTriangle, Users, ArrowRight } from 'lucide-react';
    ...
    return (
        <PageLayout>
            ...
            <div className="container py-4">
                <Link to="/international-tours/thailand" className="flex items-center gap-2 text-sm text-muted-foreground hover:text-teal-600 transition-colors">
                    <ArrowRight className="w-4 h-4 rotate-180" /> Back to Thailand Guide
                </Link>
            </div>
