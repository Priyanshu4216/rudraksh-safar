...
const LadakhFromRaipur = () => {
    const heroImage = "https://images.unsplash.com/photo-1580136608079-72029d0de130?q=80&w=2070";
            ...
            <div className="container py-12 lg:py-20">
                ...
                <div className="grid lg:grid-cols-2 gap-12 items-center mb-16">
                    ...
                    <div className="relative group">
                        ...
                        <img src="https://images.unsplash.com/photo-1517649763962-0c623066013b?q=80&w=2070" className="relative rounded-xl shadow-2xl" alt="Raipur Group in Ladakh" />
                    </div>
                </div>
                ...
                <section className="mb-20">
                    ...
                    <div className="grid md:grid-cols-2 gap-8">
                        ...
                        <Link to="/ladakh-tour-via-srinagar" className="group block relative rounded-2xl overflow-hidden aspect-video">
                            <img src="https://images.unsplash.com/photo-1566324814882-62cebb6330ce?q=80&w=2070" alt="Srinagar Route" className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110" />
                        ...
                        <Link to="/ladakh-tour-via-manali" className="group block relative rounded-2xl overflow-hidden aspect-video">
                            <img src="https://images.unsplash.com/photo-1626621341476-3b37d7a9693c?q=80&w=2067" alt="Manali Route" className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110" />
                            <div className="absolute inset-0 bg-gradient-to-t from-black/80 to-transparent flex flex-col justify-end p-8">
