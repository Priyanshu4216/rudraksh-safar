...
const LadakhFromBhilai = () => {
    const heroImage = "https://images.unsplash.com/photo-1595846519845-68e298c2edd8?q=80&w=2070";
                ...
                <div className="grid lg:grid-cols-2 gap-12 items-center mb-16">
                    ...
                    <div className="relative">
                        <div className="aspect-square rounded-2xl overflow-hidden shadow-2xl relative">
                            <img src="https://images.unsplash.com/photo-1579619623727-2c9769da812f?q=80&w=2070" className="object-cover w-full h-full" alt="Bhilai Travelers" />
                    ...
                    <div className="grid md:grid-cols-2 gap-8">
                        <div className="bg-card border border-border rounded-xl overflow-hidden">
                            <div className="h-48 overflow-hidden">
                                <img src="https://images.unsplash.com/photo-1549488346-6014e76c126d?q=80&w=2070" className="w-full h-full object-cover" alt="Family" />
                            </div>
                            <div className="p-6">
                        ...
                        <div className="bg-card border border-border rounded-xl overflow-hidden">
                            <div className="h-48 overflow-hidden">
                                <img src="https://images.unsplash.com/photo-1595846519845-68e298c2edd8?q=80&w=2070" className="w-full h-full object-cover" alt="Bike" />
                            </div>
                            <div className="p-6">
