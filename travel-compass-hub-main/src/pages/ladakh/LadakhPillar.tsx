...
const LadakhPillar = () => {
    const heroImage = "/images/ladakh/ladakh-img-12.webp"; // Placeholder - high quality Ladakh image
                    ...
                    <div className="lg:col-span-8 space-y-12">
                            ...
                            <div className="grid md:grid-cols-2 gap-8">
                                ...
                                <div className="group relative overflow-hidden rounded-2xl border border-border bg-card">
                                    <div className="aspect-[4/3] overflow-hidden">
                                        <img
                                            src="/images/ladakh/ladakh-img-3.webp"
                                ...
                                <div className="group relative overflow-hidden rounded-2xl border border-border bg-card">
                                    <div className="aspect-[4/3] overflow-hidden">
                                        <img
                                            src="/images/ladakh/ladakh-img-15.webp"
                        ...
                        <section id="featured-expedition" className="relative group overflow-hidden rounded-3xl border border-gold/30 bg-black text-white">
                            <div className="absolute inset-0">
                                <img src="/images/ladakh/ladakh-img-1.webp" alt="Ultimate Ladakh Expedition" className="w-full h-full object-cover opacity-60 group-hover:scale-105 transition-transform duration-1000" />
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="flex flex-col md:flex-row gap-4 bg-muted/30 p-4 rounded-xl border border-border hover:border-gold/30 transition-all">
                                    <div className="w-full md:w-48 h-32 rounded-lg overflow-hidden shrink-0">
                                        <img src="/images/ladakh/ladakh-img-2.webp" className="w-full h-full object-cover" alt="Ladakh Bike Trip" />
                                    </div>
                                ...
                                <div className="flex flex-col md:flex-row gap-4 bg-muted/30 p-4 rounded-xl border border-border hover:border-gold/30 transition-all">
                                    <div className="w-full md:w-48 h-32 rounded-lg overflow-hidden shrink-0">
                                        <img src="/images/ladakh/ladakh-img-11.webp" className="w-full h-full object-cover" alt="Ladakh Family Tour" />
                                    </div>
                                    <div className="flex-1">
                                        <div className="flex justify-between items-start">
                                            <div>
                                ...
                                <ul className="space-y-3">
                                    <li>
                                        <Link to="/places-to-visit-in-ladakh/pangong-lake" className="flex items-center gap-3 group">
                                            <img src="/images/ladakh/ladakh-img-4.webp" className="w-12 h-12 rounded-lg object-cover" alt="Pangong" />
                                            <div>
                                    ...
                                    <li>
                                        <Link to="/places-to-visit-in-ladakh/nubra-valley" className="flex items-center gap-3 group">
                                            <img src="/images/ladakh/ladakh-img-5.webp" className="w-12 h-12 rounded-lg object-cover" alt="Nubra" />
                                            <div>
                                    ...
                                    <li>
                                        <Link to="/places-to-visit-in-ladakh/umling-la-pass" className="flex items-center gap-3 group">
                                            <img src="/images/ladakh/ladakh-img-6.webp" className="w-12 h-12 rounded-lg object-cover" alt="Umling La" />
                                            <div>
