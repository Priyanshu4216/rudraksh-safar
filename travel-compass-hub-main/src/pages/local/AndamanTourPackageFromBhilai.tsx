...
import { Ship, Plane, Map, Anchor, Sun, CreditCard } from 'lucide-react';
...
const AndamanTourPackageFromBhilai = () => {
    return (
        <PageLayout>
            ...
            <ContentSection className="bg-blue-50">
                <div className="flex flex-col md:flex-row gap-6 items-center">
                    <div className="flex-1">
                        <h2 className="text-2xl font-bold text-blue-900 mb-4">Reaching Andaman from Bhilai</h2>
                        ...
                        <div className="space-y-4">
                            <div className="bg-white p-4 rounded-lg shadow-sm border-l-4 border-green-500">
                                <h4 className="font-bold text-green-700">Option 1: The Quickest (Flight)</h4>
                                <p className="text-sm">Raipur &rarr; Kolkata &rarr; Port Blair.</p>
                                <p className="text-xs text-gray-500">Duration: ~6 Hours total. Best for Honeymooners.</p>
                            </div>
                            <div className="bg-white p-4 rounded-lg shadow-sm border-l-4 border-orange-500">
                                <h4 className="font-bold text-orange-700">Option 2: The Budget / LTC Saver</h4>
                                <p className="text-sm">Train: Durg &rarr; Kolkata (Howrah) [Overnight]</p>
                                <p className="text-sm">Flight: Kolkata &rarr; Port Blair</p>
                                <p className="text-xs text-gray-500">Why? Flights from Kolkata are cheaper than from Raipur. Train fare is negligible.</p>
                            </div>
                        </div>
                    </div>

                    <div className="bg-white p-6 rounded-lg shadow-md max-w-sm border border-blue-200">
                        <h3 className="font-bold text-lg mb-3 text-blue-800 flex items-center gap-2"><Anchor className="w-5 h-5" /> Crucial Advice</h3>
            ...
            <ContentSection title="The Island Hopping Plan (5N/6D)" className="bg-white">
                <div className="grid md:grid-cols-3 gap-4">
                    <div className="p-4 border rounded-lg hover:bg-slate-50 transition">
                        ...
                        <p className="text-sm text-gray-600">Arrival. Corbyn's Cove Beach. <strong>Cellular Jail (Kala Pani)</strong> Light & Sound Show (A patriotic must-do).</p>
                    </div>
                    <div className="p-4 border rounded-lg hover:bg-slate-50 transition">
                        <div className="text-4xl mb-2">🏝️</div>
                        <h4 className="font-bold text-lg">Day 2-3: Havelock (Swaraj Dweep)</h4>
                        <p className="text-sm text-gray-600">Private Cruise to Havelock. <strong>Radhanagar Beach</strong> (Asia's Best Beach). Scuba Diving at Nemo Reef.</p>
                    </div>
                    <div className="p-4 border rounded-lg hover:bg-slate-50 transition">
                        <div className="text-4xl mb-2">🪸</div>
                        <h4 className="font-bold text-lg">Day 4-5: Neil Island & Return</h4>
                        <p className="text-sm text-gray-600">Cruise to Neil Island. Bharatpur Beach (Corals). Natural Bridge. Return to Port Blair for shopping.</p>
                    </div>
                </div>
            </ContentSection>

            {/* 4. LTC Special Section */}
            <ContentSection className="bg-yellow-50" id="ltc-info">
                <div className="text-center max-w-2xl mx-auto">
                    <h3 className="text-2xl font-bold text-yellow-900 mb-4 flex justify-center items-center gap-2">
                    ...
                    <ul className="text-left bg-white p-6 rounded-lg shadow-sm space-y-3 inline-block w-full">
