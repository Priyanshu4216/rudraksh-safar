...
import { Plane, Car, Users, CalendarCheck, ShieldCheck } from 'lucide-react';
...
const DubaiTourPackageFromBhilai = () => {
    return (
        <PageLayout>
                ...
                <div className="max-w-4xl mx-auto">
                    ...
                    <div className="grid md:grid-cols-3 gap-6 text-center">
                        <div className="p-4 border rounded-lg bg-slate-50">
                            <Car className="w-10 h-10 text-indigo-600 mx-auto mb-3" />
                            <h3 className="font-bold text-lg">Home Pickup</h3>
                            <p className="text-sm text-gray-600">For group bookings (4+), we provide a cab from your home in Bhilai (Sec-1 to Sec-10, Nehru Nagar) to Raipur Airport.</p>
                        </div>
                        <div className="p-4 border rounded-lg bg-slate-50">
                            <Users className="w-10 h-10 text-indigo-600 mx-auto mb-3" />
                            <h3 className="font-bold text-lg">Group Safety</h3>
                            <p className="text-sm text-gray-600">First time abroad? Don't worry. You travel with a group of 10-15 people from Chhattisgarh. Local company.</p>
                        </div>
                        <div className="p-4 border rounded-lg bg-slate-50">
                            <ShieldCheck className="w-10 h-10 text-indigo-600 mx-auto mb-3" />
                            <h3 className="font-bold text-lg">Kitchen Support</h3>
                            <p className="text-sm text-gray-600">We prioritize hotels in Bur Dubai that serve Poha/Paratha breakfast. No bread-butter compulsion.</p>
                        </div>
                    </div>
                </div>
            </ContentSection>
            ...
            <ContentSection className="bg-indigo-50">
                <div className="flex flex-col md:flex-row gap-8 items-center">
                    <div className="flex-1">
                        <h3 className="text-2xl font-bold text-indigo-900 mb-4">Visa for Housewives & Students?</h3>
                        <p className="mb-4">
                        ...
                        <div className="bg-white p-3 rounded font-medium text-indigo-700 border border-indigo-200 inline-block">
                            Required: Passport (Front/Back) + Photo + Pan Card. That's it.
                        </div>
                    </div>
                    <div className="w-full md:w-1/3">
                        <div className="bg-white p-6 rounded shadow-lg">
                            <h4 className="font-bold text-gray-800 mb-4 border-b pb-2">Batch Departure Dates</h4>
                            <ul className="space-y-3 text-sm">
                                ...
                                <li className="flex justify-between">
                                    ...
                                    <span className="text-orange-600 font-bold">Filling Fast</span>
                                </li>
                                <li className="flex justify-between">
            ...
            <ContentSection title="6 Days: The 'Photogenic' Plan" className="bg-white">
                <div className="space-y-4">
                    <p className="text-gray-600 italic mb-6 text-center"> Designed for Instagram & WhatsApp Status updates.</p>
                    <div className="grid md:grid-cols-2 gap-6">
                        <div className="border p-4 rounded hover:shadow-md transition">
                            <h4 className="font-bold text-lg text-pink-600">Day 2: The View</h4>
                            <p className="text-sm text-gray-600">Burj Khalifa Top + Dubai Mall Aquarium (Outside). Perfect profile picture spot.</p>
                        </div>
                        <div className="border p-4 rounded hover:shadow-md transition">
                            <h4 className="font-bold text-lg text-pink-600">Day 3: The Adventure</h4>
                            <p className="text-sm text-gray-600">Desert Safari. Wear traditional clothes. Get Henna (Mehendi) done on hands. Camel photos.</p>
                        </div>
                        <div className="border p-4 rounded hover:shadow-md transition">
                            <h4 className="font-bold text-lg text-pink-600">Day 4: The Miracle</h4>
                            <p className="text-sm text-gray-600">Miracle Garden (World's biggest flower garden) OR Global Village (Shopping form 90 countries). <i>*Seasonal</i></p>
                        </div>
                        <div className="border p-4 rounded hover:shadow-md transition">
                            <h4 className="font-bold text-lg text-pink-600">Day 5: Gold Shopping</h4>
                            <p className="text-sm text-gray-600">Meena Bazaar & Gold Souk. We guide you where to get Indian designs.</p>
                        </div>
                    </div>
                </div>
            </ContentSection>
            ...
            <ContentSection className="bg-red-50">
                <h3 className="text-xl font-bold text-red-800 mb-2">Not for Bachelors?</h3>
