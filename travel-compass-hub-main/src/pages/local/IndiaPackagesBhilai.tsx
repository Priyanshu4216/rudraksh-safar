...
const IndiaPackagesBhilai = () => {
  ...
  const destinations = [
    ...
    { name: "Kerala", price: "₹14,999", days: "5N/6D", image: "https://images.unsplash.com/photo-1602216056096-3b40cc0c9944?auto=format&fit=crop&q=80&w=800", link: "/kerala-tour-package-from-bhilai", highlights: ["Backwaters", "Munnar", "Alleppey"] },
    { name: "Kashmir", price: "₹17,999", days: "5N/6D", image: "https://images.unsplash.com/photo-1715457573748-8e8a70b2c1be?q=80&w=1171&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D", link: "/kashmir-tour-package-from-bhilai", highlights: ["Srinagar", "Gulmarg", "Pahalgam"] },
    ...
    { name: "Himachal", price: "₹11,999", days: "5N/6D", image: "https://images.unsplash.com/photo-1712388430474-ace0c16051e2?q=80&w=1074&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D", link: "/manali-tour-package-from-bhilai", highlights: ["Manali", "Shimla", "Dharamshala"] },
