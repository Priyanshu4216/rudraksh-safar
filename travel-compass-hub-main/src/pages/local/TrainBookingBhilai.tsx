                                ...
                                <TableBody>
                                    {popularTrains.map((train, index) => (
                                        <TableRow key={index}>
                                            ...
                                            <TableCell>
                                                <span className={`text-xs px-2 py-1 rounded-full font-medium ${train.availability.includes('Heavy') || train.availability.includes('High') ? 'bg-red-100 text-red-700 dark:bg-red-900/30 dark:text-red-300' : 'bg-green-100 text-green-700 dark:bg-green-900/30 dark:text-green-300'}`}>
                                                    {train.availability}
                                                </span>
                                            </TableCell>
                                        </TableRow>
