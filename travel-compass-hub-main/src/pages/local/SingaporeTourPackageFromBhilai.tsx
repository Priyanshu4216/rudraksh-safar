...
import { Plane, Building2, Map, Coffee, FileText } from 'lucide-react';
            ...
            <main className="min-h-screen bg-background text-foreground">
                ...
                >
                    <div className="container mx-auto px-4 mt-6">
                        <Breadcrumbs items={[{ label: 'Home', path: '/' }, { label: 'Bhilai Packages', path: '/tour-packages-from-bhilai' }, { label: 'Singapore Tours', path: '/singapore-tour-package-from-bhilai' }]} />
                    </div>
                </LocationHero>
