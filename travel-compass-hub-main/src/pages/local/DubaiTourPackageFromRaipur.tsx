...
import { Plane, Globe, ShieldCheck, Sun, Building2, ShoppingBag } from 'lucide-react';
        ...
        <PageLayout>
            ...
            <ContentSection className="bg-white">
                <div className="prose max-w-none">
                    ...
                    <div className="border-l-4 border-yellow-600 pl-4 mt-4 bg-yellow-50 p-4 rounded-r-lg">
                        <h3 className="font-bold text-xl text-yellow-900 mb-2">Cost of Dubai Trip from Raipur?</h3>
                        <p className="mb-2">
            ...
            <ContentSection title="Reaching Dubai: The Mumbai Hub" className="bg-slate-50">
                <div className="grid md:grid-cols-2 gap-8">
                    ...
                    <div className="bg-white p-6 rounded-lg shadow border-t-4 border-blue-500">
                        ...
                        <p className="text-gray-600 mb-2 text-sm">Most Frequent & Reliable.</p>
                    ...
                    <div className="bg-white p-6 rounded-lg shadow border-t-4 border-indigo-500">
                        ...
                        <p className="text-gray-600 mb-2 text-sm">Good for Indigo Connections.</p>
                        <ol className="list-decimal ml-5 space-y-2 text-gray-700">
                ...
                <div className="mt-6 bg-green-100 p-4 rounded text-green-800 flex gap-3 items-start">
            ...
            <ContentSection title="6-Day 'Future City' Itinerary" className="bg-white">
                <div className="space-y-6">
                    <div className="flex gap-4">
                        <div className="w-12 h-12 bg-yellow-100 text-yellow-700 rounded-full flex items-center justify-center font-bold shrink-0">D1</div>
                        <div>
                            <h4 className="font-bold text-lg">Arrival & Dhow Cruise</h4>
                            <p className="text-gray-600">Land in Dubai. Transfer to Hotel (Bur Dubai/Deira). Evening <strong>Marina Dhow Cruise</strong> with dinner on board. View the glittering skyline.</p>
                        </div>
                    </div>
                    <div className="flex gap-4">
                        <div className="w-12 h-12 bg-yellow-100 text-yellow-700 rounded-full flex items-center justify-center font-bold shrink-0">D2</div>
                        <div>
                            <h4 className="font-bold text-lg">Dubai City Tour & Burj Khalifa</h4>
                            <p className="text-gray-600">Half-day city tour (Dubai Frame, Zabeel Palace). Evening: <strong>Burj Khalifa (124th Floor)</strong>. Watch the Fountain Show at Dubai Mall.</p>
                        </div>
                    </div>
                    <div className="flex gap-4">
                        <div className="w-12 h-12 bg-yellow-100 text-yellow-700 rounded-full flex items-center justify-center font-bold shrink-0">D3</div>
                        <div>
                            <h4 className="font-bold text-lg">Future Museum & Desert Safari</h4>
                            <p className="text-gray-600">Morning visit to Museum of the Future (Book 1 month ahead!). Afternoon: pick up for <strong>Desert Safari</strong> (Dune Bashing, Camel Ride, BBQ Dinner, Belly Dance).</p>
                        </div>
                    </div>
                    <div className="flex gap-4">
                        <div className="w-12 h-12 bg-yellow-100 text-yellow-700 rounded-full flex items-center justify-center font-bold shrink-0">D4</div>
                        <div>
                            <h4 className="font-bold text-lg">Day Trip to Abu Dhabi</h4>
                            <p className="text-gray-600">Full day tour to UAE Capital. Visit the grand <strong>Sheikh Zayed Mosque</strong> (Cover full body). Visit Ferrari World or Yas Waterworld (Optional).</p>
                        </div>
                    </div>
                    <div className="flex gap-4">
                        <div className="w-12 h-12 bg-yellow-100 text-yellow-700 rounded-full flex items-center justify-center font-bold shrink-0">D5</div>
                        <div>
                            <h4 className="font-bold text-lg">Shopping & Leisure (Global Village)</h4>
                            <p className="text-gray-600">Morning free for Gold Souk/Meena Bazaar. Evening visit to <strong>Global Village</strong> (Nov-Apr only) or Miracle Garden.</p>
                        </div>
                    </div>
                    <div className="flex gap-4">
                        <div className="w-12 h-12 bg-yellow-100 text-yellow-700 rounded-full flex items-center justify-center font-bold shrink-0">D6</div>
                        <div>
                            <h4 className="font-bold text-lg">Departure</h4>
                            <p className="text-gray-600">Last minute shopping at Duty Free. Fly back to Raipur via Mumbai.</p>
                        </div>
                    </div>
                </div>
            </ContentSection>
            ...
            <ContentSection title="Comparison: Dubai vs Singapore" className="bg-indigo-50">
            ...
            <ContentSection className="bg-red-50">
                <h3 className="text-2xl font-bold text-red-800 mb-4">Who Should Avoid Dubai?</h3>
            ...
            <ContentSection className="border-t">
                ...
                <div className="flex flex-wrap gap-4 text-indigo-600">
                    <a href="/thailand-tour-package-from-raipur" className="hover:underline">Thailand Packages</a>
                    <a href="/international-tours-from-raipur" className="hover:underline">All International Tours</a>
                </div>
            </ContentSection>
