        ...
        <PageLayout>
            ...
            <ContentSection className="border-t bg-muted/20">
                ...
                <div className="flex flex-wrap gap-4 text-primary">
                    <Link to="/goa-trip-under-10000-from-bhilai" className="hover:underline">10k Budget Challenge</Link>
                    <Link to="/goa-budget-itinerary-from-cg" className="hover:underline">Day-wise Plan</Link>
                </div>
            </ContentSection>
        </PageLayout>
    );
