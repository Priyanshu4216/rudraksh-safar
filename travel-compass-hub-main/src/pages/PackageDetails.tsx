...
const allPackages = [
  ...
  },
  {
    ...
    itinerary: [
      'Day 1: Arrival at Bagdogra Airport (IXB) / NJP Railway Station. Transfer to Gangtok (approx 4-5 hrs). Check-in to hotel. Evening free to stroll at MG Marg.',
      'Day 2: Full day excursion tour to Tsomgo Lake (12,400 ft.) and Baba Mandir. Enjoy snow and yak rides.',
  ...
  },
  {
    ...
    whatToEat: ['Nasi Lemak', 'Satay', 'Laksa', 'Roti Canai', 'Teh Tarik'],
    attractions: ['Cable Car Ride', 'Theme Parks', 'Cave Exploration', 'Island Hopping', 'Shopping'],
    itinerary: [
      'Day 1: Arrival in Kuala Lumpur. Transfer to hotel. Evening visit to KL Tower and Jalan Alor for street food.',
      'Day 2: Half-day Kuala Lumpur City Tour (Petronas Towers, King\'s Palace, National Mosque). Afternoon free for shopping at Bukit Bintang.',
      'Day 3: Full day Genting Highlands tour. Ride the cable car, visit Batu Caves en route, and enjoy the indoor/outdoor theme parks.',
      'Day 4: Day trip to Sunway Lagoon Theme Park (6 parks in 1). Enjoy water rides and wildlife park. OR Leisure day for shopping.',
      'Day 5: Morning leisure or souvenir shopping at Central Market. Transfer to airport for departure.',
    ],
    aeoFaqs: [
      { question: "Is visa required for Malaysia from India?", answer: "Currently, Malaysia offers visa-free entry for Indian citizens for stays up to 30 days. Travelers just need to fill the MDAC (Malaysia Digital Arrival Card) online before travel." },
      { question: "What is the best time to visit Malaysia?", answer: "Malaysia is a year-round destination, but the best time is generally from December to April. The east coast is best visited from April to October." },
      { question: "Can we get vegetarian food in Malaysia?", answer: "Yes, Malaysia has a large Indian community, so finding Indian vegetarian food is very easy in cities like Kuala Lumpur and Genting Highlands." },
      { question: "How much does a Malaysia trip cost from Bhilai?", answer: "A 5-day Malaysia trip from Bhilai/Raipur typically starts from ₹45,000 - ₹50,000 per person including flights, visa, hotels, and sightseeing." }
    ],
    gallery: [
      'https://images.unsplash.com/photo-1596422846543-75c6fc197f07?q=80&w=2070&auto=format&fit=crop',
      'https://images.unsplash.com/photo-1581454652285-d6ca04724578?q=80&w=2070&auto=format&fit=crop',
      'https://images.unsplash.com/photo-1544976735-e51c863a35b1?q=80&w=2070&auto=format&fit=crop',
    ],
  },
  {
    id: 'vietnam',
    ...
    famousPlaces: ['Ha Long Bay', 'Hanoi Old Quarter', 'Golden Bridge (Da Nang)', 'Hoi An', 'Ba Na Hills'],
    whatToEat: ['Pho', 'Banh Mi', 'Egg Coffee', 'Spring Rolls', 'Bun Cha'],
    attractions: ['Overnight Cruise', 'Basket Boat Ride', 'Ancient Town Walk', 'Cave Tours', 'French Architecture'],
    itinerary: [
      'Day 1: Arrival in Hanoi. Transfer to hotel in Old Quarter. Evening Water Puppet Show and Cyclo ride.',
      'Day 2: Drive to Ha Long Bay. Board the luxury cruise. Lunch on board, kayak to caves, swimming. Sunset party and overnight on cruise.',
      'Day 3: Tai Chi on deck, visit floating village. Brides, brunch, and disembark. Drive back to Hanoi airport, flight to Da Nang.',
      'Day 4: Full day Ba Na Hills tour. Cable car ride to Golden Bridge (Hands of God). Play at Fantasy Park. Return to Da Nang.',
      'Day 5: Visit Hoi An Ancient Town. Basket boat ride at Cam Thanh Coconut Village. Lantern making class. Evening in Hoi An.',
      'Day 6: Morning leisure or beach time. Transfer to Da Nang airport for departure.',
    ],
    aeoFaqs: [
      { question: "How to get Vietnam visa for Indians?", answer: "Indian citizens can easily apply for a Vietnam e-Visa online, which is usually processed within 3 working days and valid for 30-90 days." },
      { question: "Is Vietnam cheap for Indian tourists?", answer: "Yes, Vietnam is very affordable. The currency (Dong) is weaker than INR, making food, shopping, and transport very budget-friendly for Indians." },
      { question: "What is the best route to reach Vietnam from Raipur?", answer: "The best route is Raipur -> Kolkata -> Hanoi/Ho Chi Minh City, or Raipur -> Delhi -> Vietnam. VietJet and Indigo offer good connectivity." },
      { question: "Is vegetarian food available in Vietnam?", answer: "Yes, 'Chay' (vegetarian) restaurants are common, and most places offer tofu and vegetable dishes. Indian restaurants are also available in major cities." }
    ],
    gallery: [
      'https://images.unsplash.com/photo-1528127220198-3498b6eb06ba?q=80&w=2070&auto=format&fit=crop',
      'https://images.unsplash.com/photo-1552353617-3bfd67f72cb9?q=80&w=2070&auto=format&fit=crop',
      'https://images.unsplash.com/photo-1509038238382-3d717f935390?q=80&w=2070&auto=format&fit=crop',
    ],
  },
  {
    id: 'mauritius',
    ...
    famousPlaces: ['Ile Aux Cerfs', 'Seven Colored Earth', 'Port Louis', 'Casela Park', 'Trou aux Biches'],
    whatToEat: ['Dholl Puri', 'Seafood', 'Mauritian Curry', 'Gateau Piment', 'Fried Noodles'],
    attractions: ['Catamaran Cruise', 'Undersea Walk', 'Wildlife Safari', 'Water Sports', 'Botanical Gardens'],
    itinerary: [
      'Day 1: Arrival in Mauritius. Transfer to beach resort. Welcome dinner and leisure.',
      'Day 2: North Island Tour: Port Louis city, Caudan Waterfront, and Pamplemousses Botanical Garden.',
      'Day 3: South Island Tour: Trou aux Cerfs volcano crater, Grand Bassin (Ganga Talao), and Chamarel Seven Colored Earth.',
      'Day 4: Full Day Ile Aux Cerfs Island tour by speedboat. Enjoy parasailing and tube rides. Beach BBQ lunch.',
      'Day 5: Catamaran Cruise with dolphin watching and snorkeling. Sunset dinner on board.',
      'Day 6: Leisure day. Optional Casela Nature Park visit for walking with lions or quad biking. Spa session.',
      'Day 7: Morning free for beach activities. Airport transfer for departure.',
    ],
    aeoFaqs: [
      { question: "Is Mauritius visa free for Indians?", answer: "Yes, Mauritius offers Visa on Arrival free of cost for Indian tourists. You just need a valid passport, return ticket, and hotel booking." },
      { question: "Is Mauritius good for honeymoon?", answer: "Mauritius is a top honeymoon destination offering luxury resorts, private beaches, romantic cruises, and adventure activities." },
      { question: "What currency should we carry to Mauritius?", answer: "You can carry USD or Euros and exchange them for Mauritian Rupee. Many places also accept international credit cards." },
      { question: "How long is the flight from India to Mauritius?", answer: "Direct flights from Mumbai/Delhi to Mauritius take about 6-7 hours. From Raipur, you will have a layover in Mumbai/Delhi." }
    ],
    gallery: [
      'https://images.unsplash.com/photo-1555547432-8411a7686567?q=80&w=2070&auto=format&fit=crop',
