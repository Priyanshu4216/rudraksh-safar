...
import { Heart, Music, Umbrella, Users, ArrowRight } from 'lucide-react';
        ...
        <PageLayout>
            ...
            <ContentSection className="border-t">
                ...
                <div className="flex flex-wrap gap-4 text-indigo-600">
                    <Link to="/domestic-tours/goa-from-bhilai" className="hover:underline">Main Package</Link>
                    <Link to="/domestic-tours/goa-budget-itinerary" className="hover:underline">Suggested Itinerary</Link>
                </div>
            </ContentSection>
