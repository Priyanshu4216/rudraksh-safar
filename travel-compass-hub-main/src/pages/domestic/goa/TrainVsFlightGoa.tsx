...
import { Train, Plane, Clock, DollarSign, ArrowRight } from 'lucide-react';
        ...
        <PageLayout>
            ...
            <ContentSection className="border-t">
                ...
                <div className="flex flex-wrap gap-4 text-indigo-600">
                    <Link to="/domestic-tours/goa-from-raipur" className="hover:underline">Flight Packages</Link>
                    <Link to="/domestic-tours/goa-from-durg" className="hover:underline">Train Packages</Link>
                </div>
            </ContentSection>
