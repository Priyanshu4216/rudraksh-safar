...
import { Users, Bike, Wallet, Music, MapPin, AlertCircle, ArrowRight } from 'lucide-react';
            ...
            <ContentSection title="The ₹9,000 Challenge" className="bg-white">
                <div className="flex flex-col md:flex-row gap-8 items-center">
                    ...
                    <div className="flex-1 bg-slate-100 p-6 rounded-xl">
                        ...
                        <div className="mt-6">
                            <Link to="/domestic-tours/goa-trip-under-10000" className="text-primary font-bold hover:underline">
