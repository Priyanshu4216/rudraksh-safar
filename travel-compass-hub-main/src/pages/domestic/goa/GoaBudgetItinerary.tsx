...
import { MapPin, Coffee, Camera, Sun, ArrowRight } from 'lucide-react';
...
const GoaBudgetItinerary = () => {
    return (
        <PageLayout>
            ...
            {/* Day 1 */}
            <ContentSection title="Day 1: Arrival & North Goa Vibes" className="bg-blue-50 dark:bg-blue-950/30">
                <div className="flex gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-gray-700 dark:text-gray-300">Arrive at station. Take a shared bus/shuttle to Calangute/Baga (Save ₹800 vs Taxi). Check into your hostel/budget hotel. <strong>Immediately rent a scooty</strong> (₹350-400/day). Do not delay this.</p>
                    </div>
                </div>
                <div className="flex gap-4 mt-6">
                    ...
                    <div>
                        ...
                        <p className="text-gray-700 dark:text-gray-300">Head to <strong>Calangute Beach</strong> for sunset. Avoid expensive shacks. Grab a beer/juice from a wine shop and sit on the sand (where allowed) or find a budget shack at the far end of the beach.</p>
                    </div>
                </div>
            </ContentSection>

            {/* Day 2 */}
            <ContentSection title="Day 2: Forts & Party Vibes" className="bg-white dark:bg-background">
                <div className="flex gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-gray-700 dark:text-gray-300">Ride to <strong>Chapora Fort</strong> (Free entry). Then head to <strong>Vagator Beach</strong>. Lunch at a local thali joint in Anjuna (Burger Factory is good but pricey, try local Goan fish curry rice for ₹200).</p>
                    </div>
                </div>
                <div className="flex gap-4 mt-6">
                    ...
                    <div>
                        ...
                        <p className="text-gray-700 dark:text-gray-300">Visit Anjuna Flea Market (Wednesdays) or just soak in the vibe at Curlies (entry covers food). It's cheaper than Club Cabana/Tito's.</p>
                    </div>
                </div>
            </ContentSection>

            {/* Day 3 */}
            <ContentSection title="Day 3: South Goa Peace" className="bg-green-50 dark:bg-green-950/20">
                <p className="mb-4 font-bold text-red-600 dark:text-red-400">Warning: Long ride (60km). Start early (8 AM).</p>
            ...
            {/* Day 4 */}
            <ContentSection title="Day 4: Panjim & Departure" className="bg-white dark:bg-background">
            ...
            <ContentSection className="border-t">
                ...
                <div className="flex flex-wrap gap-4 text-indigo-600">
                    ...
                    <Link to="/domestic-tours/goa-trip-under-10000" className="hover:underline">Cost Breakdown</Link>
                    <Link to="/domestic-tours/goa-package-from-durg" className="hover:underline">Train Info</Link>
                </div>
            </ContentSection>
